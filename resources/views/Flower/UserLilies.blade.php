...
<body>
    ...
    <div class="header-prod position-relative d-flex justify-content-center align-items-center">
        <img src="../img/header-lilies.jpg" alt="">
        <h1 class="position-absolute top-25 z-3 p-2">Lilies Flower</h1>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mt-3 card-container">
                <div class="card border-0 rounded shadow">
                    <img src="../image/{{$l->ProductImage}}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="text-center product-name">{{$l->ProductName}}</h5>
                        <h5 class="text-center product-price">&#8369; {{$l->ProductPrice}}</h5>
                    </div>
                    <div class="layer">
                        <h6 class="product-description">{{$l->ProductDescription}}</h6>
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal{{$l->ProductID}}">
                            View detail
                        </button>
                    </div>
                </div>
            ...
            <div class="modal fade" id="exampleModal{{$l->ProductID}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <div class="card">
                                <div class="card-body shadow">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <img src="../image/{{$l->ProductImage}}" alt="" class="w-100 h-100">
                                        </div>
                                        <div class="col-md-6">
                                            <h3>{{$l->ProductName}}</h3>
                                            ...
                                            <textarea id="message-{{$l->ProductID}}" cols="30" rows="10" placeholder="Message" class="form-control"></textarea>
                                            <input type="button" id="add-to-cart-{{$l->ProductID}}" class="btn btn-outline-warning w-50 mt-3 rounded-pill text-dark" value="ADD TO CART">
            ...
            <script>
                document.getElementById('add-to-cart-{{$l->ProductID}}').addEventListener('click', function() {
                    var product = {
                        id: "{{$l->ProductID}}",
                        name: "{{$l->ProductName}}",
                        ...
                        care: "{{$l->ProductCare}}",
                        message: document.getElementById('message-{{$l->ProductID}}').value
