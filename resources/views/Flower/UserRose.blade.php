...
<body>
    ...
    <div class="header-prod position-relative d-flex justify-content-center align-items-center">
        <img src="../img/header-rose.jpg" alt="">
        <h1 class="position-absolute top-25 z-3 p-2">Rose Flower</h1>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mt-3 card-container">
                <div class="card border-0 rounded shadow">
                    <img src="../Image/{{$r->ProductImage}}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="text-center product-name">{{$r->ProductName}}</h5>
                        <h5 class="text-center product-price">&#8369; {{$r->ProductPrice}}</h5>
                    </div>
                    <div class="layer">
                        <h6 class="product-description">{{$r->ProductDescription}}</h6>
                        <br>
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal{{$r->ProductID}}">
                            View detail
                        </button>
                    </div>
                </div>
            ...
            <div class="modal fade" id="exampleModal{{$r->ProductID}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <div class="card">
                                <div class="card-body shadow">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <img src="../image/{{$r->ProductImage}}" alt="" class="w-100 h-100">
                                        </div>
                                        <div class="col-md-6">
                                            <h3>{{$r->ProductName}}</h3>
                                            ...
                                            <textarea id="message-{{$r->ProductID}}" cols="30" rows="10" placeholder="Message" class="form-control"></textarea>
                                            <input type="button" id="add-to-cart-{{$r->ProductID}}" class="btn btn-outline-warning w-50 mt-3 rounded-pill text-dark" value="ADD TO CART">
            ...
            <script>
                document.getElementById('add-to-cart-{{$r->ProductID}}').addEventListener('click', function() {
                    var product = {
                        id: "{{$r->ProductID}}",
                        name: "{{$r->ProductName}}",
                        ...
                        care: "{{$r->ProductCare}}",
                        message: document.getElementById('message-{{$r->ProductID}}').value
