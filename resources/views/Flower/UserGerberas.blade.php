...
<body>
    ...
    <div class="header-prod position-relative d-flex justify-content-center align-items-center">
        <img src="../img/header-gerberas.jpg" alt="">
        <h1 class="position-absolute top-25 z-3 p-2">Gerberas Flower</h1>
    </div>
    ...
    <div class="container mt-3">
        <div class="row">
            ...
            @foreach ($Gerberas as $g)
            <div class="col-md-4 mt-3 card-container">
                <div class="card border-0 rounded shadow">
                    <img src="../image/{{$g->ProductImage}}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="text-center product-name">{{$g->ProductName}}</h5>
                        <h5 class="text-center product-price">&#8369; {{$g->ProductPrice}}</h5>
                    </div>
                    <div class="layer">
                        <h6 class="product-description">{{$g->ProductDescription}}</h6>
                        <br>
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal{{$g->ProductID}}">
                            View detail
                        </button>
                    </div>
                </div>
             ...
             <div class="modal fade" id="exampleModal{{$g->ProductID}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <div class="card">
                                <div class="card-body shadow">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <img src="../image/{{$g->ProductImage}}" alt="" class="w-100 h-100">
                                        </div>
                                        <div class="col-md-6">
                                            <h3>{{$g->ProductName}}</h3>
                                            <h5>&#8369;{{$g->ProductPrice}}</h5>
                                            <hr>
                                            <p>Message On the Card</p>
                                            <textarea id="message-{{$g->ProductID}}" cols="30" rows="10" placeholder="Message" class="form-control"></textarea>
                                            <input type="button" id="add-to-cart-{{$g->ProductID}}" class="btn btn-outline-warning w-50 mt-3 rounded-pill text-dark" value="ADD TO CART">
            ...
            <script>
                document.getElementById('add-to-cart-{{$g->ProductID}}').addEventListener('click', function() {
                    var product = {
                        id: "{{$g->ProductID}}",
                        name: "{{$g->ProductName}}",
                        ...
                        care: "{{$g->ProductCare}}",
                        message: document.getElementById('message-{{$g->ProductID}}').value
